...
# Create visualization/jointhgganalysis directory if it doesn't exist
if not os.path.exists('./visualization/jointhgganalysis'):
    os.makedirs('./visualization/jointhgganalysis')
...
plt.savefig('./visualization/jointhgganalysis/gene_frequency_comparison.png')
plt.close()
...
if not gene_mutations.empty:
    ...
    plt.tight_layout()
    plt.grid(axis="y", linestyle="--", alpha=0.7)
    plt.savefig('./visualization/jointhgganalysis/mutation_type_comparison.png')
    plt.close()
else:
...
plt.savefig('./visualization/jointhgganalysis/brain_location_comparison.png')
plt.close()
